...
import { FaTwitter, FaFacebook, FaGithub, FaChrome } from "react-icons/fa";
          ...
          <div className="flex justify-between py-4">
            <div>
              ...
              {coin.market_data?.market_cap ? (
                <p>₹{coin.market_data.market_cap.inr.toLocaleString("en-IN")}</p>
              ) : null}
            </div>
            <div>
              <p className="text-gray-500 text-sm">Volume (24h)</p>
              {coin.market_data?.market_cap ? (
                <p>₹{coin.market_data.total_volume.inr.toLocaleString("en-IN")}</p>
              ) : null}
            </div>
          </div>
